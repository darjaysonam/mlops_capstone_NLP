...
class EDAAnalyzer:
    ...
    def analyze_missing(self):
        ...
        missing.to_csv(os.path.join(REPORT_DIR, "missing_values.csv"))
    ...
    def feature_distributions(self):
        ...
        plt.savefig(os.path.join(REPORT_DIR, "feature_distributions.png"))
        plt.close()
    ...
    def boxplot_analysis(self):
        ...
        plt.savefig(os.path.join(REPORT_DIR, "boxplots.png"))
        plt.close()
